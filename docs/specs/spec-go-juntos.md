...
**Estructura (elegida por Victor entre 3 opciones, 2026-08-16):** primero la **CARPETA DE DOCUMENTOS** — «1 de 2» con barra de progreso, el acta con sello LISTA y el derecho de petición marcado **TE FALTA** en ámbar con su botón; al descargarlo pasa a «2 de 2» y la carpeta se pone verde. Un documento a medias pide cerrarse: eso convierte el segundo documento de dato escondido en pieza que falta. Después, un **anuncio grande** («Información que te puede servir» + «Cómo reclamarle a tu seguro sin que te den vueltas») para que se note que hay valor más allá de la descarga, y solo entonces las tarjetas.
**El derecho de petición va en LOS DOS flujos** (antes solo en el acta: quien revisaba una grieta no lo veía nunca). En grietas, los daños declarados son las grietas evaluadas.
