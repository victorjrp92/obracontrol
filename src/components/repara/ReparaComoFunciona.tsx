import { CheckCircle2, ImageUp, ListChecks } from "lucide-react";
...
const pasos = [
  {
    ...
    icon: ListChecks,
    color: "bg-blue-600",
    titulo: "Cuéntanos qué hay que reparar",
    texto:
      "En palabras normales: el muro de la sala, el techo del baño, la fachada. Te armamos la lista de trabajos con sus tiempos y sus costos.",
  },
  {
    numero: "2",
    icon: ImageUp,
    color: "bg-violet-600",
    titulo: "Cada trabajo se cierra con foto",
    texto:
      "Quien repara sube la evidencia desde su celular. Si en la casa no hay señal, se guarda y se sube sola cuando vuelve el internet.",
  },
  {
    numero: "3",
    icon: CheckCircle2,
    color: "bg-green-600",
    titulo: "Tú apruebas, y ahí sí se paga",
    texto:
      "Revisas la prueba, das el visto bueno, y llevas la cuenta de lo entregado contra lo sustentado con facturas.",
  },
];

export default function ReparaComoFunciona() {
  return (
