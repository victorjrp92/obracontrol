...
export default async function EquipoPersonalPage() {
  ...
  // Solo cuentas personales con capacidad de equipo (arquitecto/propietario).
  ...
  return (
    <>
      <Topbar
        title="Mi equipo"
        subtitle="Agrega a tu gente y comparte su enlace para que reporten desde el celular"
      />
      <main className="flex-1 overflow-y-auto p-4 sm:p-6">
        <div className="mb-5 rounded-xl bg-blue-50 border border-blue-100 p-4 text-sm text-slate-600">
          ...
          <p>
            Agrega a cada persona con sus datos, cópiale su <strong>enlace personal</strong> y compártelo
